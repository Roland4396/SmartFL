@echo off
REM Comparison Experiment: Hierarchical vs Independent Model Selection
REM ResNet-110 on CIFAR-100

echo ============================================
echo Comparison Experiment: Model Selection
echo ============================================

REM Experiment 1: Hierarchical Selection (Baseline)
echo.
...
REM Experiment 2: Independent Selection (Ablation)
echo.
